...
<p>
To reproduce this workflow, users can:
</p>
...
<p>
Alternatively, the SQL queries included in this project can be adapted to run on similar datasets or local environments.
</p>
